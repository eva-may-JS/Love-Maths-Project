...
function runGame(gameType) {
    ...
    //Every time the function runs, the answer box is wiped clean
    document.getElementById("answer-box").value = "";
    /* Every time the function runs, the cursor is in the answer box already so we can type our answer in 
